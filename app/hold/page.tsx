  ...
  return (
    <main className="hold-shell">
      ...
      <section className="hold-hero">
        <div><p className="answers-kicker">Takes about 3 minutes</p><h1>Let’s find your class time.</h1><p>Answer a few questions about your swimmer. We’ll estimate the right starting level, then text you the open class times that fit your schedule.</p></div>
